...
def main():
    ...
    run_parser.add_argument(
        "--path", action="store", help="Path to xpider project dir."
    )
    run_parser.add_argument(
        "--mongo-url", action="store", help="Mongodb url to write data."
    )
    run_parser.add_argument(
        "--redis-url", action="store", help="Redis url for queuing."
    )
